        ...
        <>
            <Row className="justify-content-start ">
                ...
                <Col sm="8">
                    ...
                    />
                    <select name="cat" className="select input-form-area mt-3 px-2" value={CatID} onChange={onSeletCategory}>
